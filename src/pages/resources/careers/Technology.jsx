...
const hero = {
  ...
  title: (
    <>
      Your Future in{" "}
      <span className="text-custom-primary">Technology & Software</span>
    </>
  ),
  blurb:
  ...
  rolesSub:
    "Explore common roles across software, infrastructure, and support.",
      ...
      items: [
        {
          ...
          text: "Building, maintaining, and testing software applications.",
          bgClass: "bg-warning-subtle",
        },
        {
          title: "Mobile Developer",
          text: "Creating applications for iOS and Android platforms.",
          bgClass: "bg-primary-subtle",
        },
        {
          title: "DevOps Engineer",
          text: "Automation, CI/CD, bridging development and operations.",
        },
      ],
    },
  },
      ...
      items: [
        {
          ...
          text: "Managing cloud platforms (AWS, Azure, GCP), IaC.",
          bgClass: "bg-warning-subtle",
        },
        {
          title: "Network Architect",
          text: "Designing and managing computer networks.",
          bgClass: "bg-primary-subtle",
        },
      ],
    },
      ...
      items: [
        {
          ...
          text: "Protecting systems and data, incident response.",
          bgClass: "bg-warning-subtle",
        },
        {
          title: "UX/UI Designer",
          text: "Improving user experience and designing intuitive interfaces.",
          bgClass: "bg-light",
        },
      ],
    },
...
const roadmap = [
  {
    step: 1,
    title: "Entry Level",
    text: "Junior Engineer / Support",
    years: "Years 0-2",
  },
  {
    step: 2,
    title: "Mid-Level",
    text: "Engineer / SRE / Specialist",
    years: "Years 3-6",
  },
  {
    step: 3,
    title: "Senior / Lead",
    text: "Team Lead / Architect",
    years: "Years 7-12",
  },
  {
    step: 4,
    title: "Manager / Principal",
    text: "Staff/Principal / Engineering Manager",
    years: "Years 15+",
  },
];
  ...
  soft: [
    {
      ...
      text: "Communication & Cross-Functional Work",
    },
...
const future = [
  {
    ...
    text: "AI is reshaping product features, tooling, and developer workflows.",
    borderClass: "border-custom-secondary",
    bgClass: "bg-warning-subtle",
  },
  {
    title: "Cloud-Native & Edge",
    text: "Serverless, containers, and edge computing enable scalable systems.",
    borderClass: "border-custom-primary",
    bgClass: "bg-primary-subtle",
  },
  {
    title: "Security & Privacy",
    text: "Secure development, privacy-by-design, and regulatory compliance become non-negotiable.",
