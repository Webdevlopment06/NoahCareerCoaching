...
const hero = {
  ...
  rolesSub:
    "Detailing high-impact roles across investment, corporate finance, and public accounting.",
      ...
      items: [
        {
          ...
          text: "Mergers & Acquisitions (M&A), raising capital (IPOs), and financial restructuring for corporations.",
          bgClass: "bg-warning-subtle",
        },
        {
          title: "Financial Advisor",
          text: "Providing personalized financial planning and wealth management for individuals and families.",
        },
        {
          title: "Equity Research Analyst",
          text: "Analyzing public companies to recommend stocks (buy, sell, hold) to investment clients.",
        },
        {
          title: "Portfolio Manager",
          text: "Building and managing investment portfolios (stocks, bonds, assets) to meet specific financial goals.",
      ...
      items: [
        {
          ...
          text: "Budgeting, forecasting, and long-term financial modeling to guide corporate strategy.",
          bgClass: "bg-warning-subtle",
        },
        {
          title: "Treasury Analyst",
          text: "Managing a company's liquidity, cash flow, and raising debt/equity financing.",
          bgClass: "bg-primary-subtle",
        },
        {
          title: "Chief Financial Officer (CFO)",
          text: "Top executive overseeing all financial operations, strategy, and risk management.",
        },
      ],
    },
  },
      ...
      items: [
        {
          ...
          text: "Auditing, tax preparation, and financial statement preparation for external reporting.",
          bgClass: "bg-warning-subtle",
        },
        {
          title: "Forensic Accountant",
          text: "Investigating financial crimes, fraud, and disputes using deep accounting knowledge.",
          bgClass: "bg-primary-subtle",
        },
        {
          title: "Internal Auditor",
          text: "Evaluating a company's internal controls, governance, and risk management processes.",
        },
      ],
    },
  },
...
const roadmap = [
  {
    ...
    text: "Finance Intern / Accounting or Banking Assistant / Client Service Associate",
    years: "Years 0-2",
  },
  {
    step: 2,
    title: "Education & Entry-Level Roles",
    text: "Financial Analyst / Staff Accountant / Investment or Credit Analyst",
    years: "Years 2-5",
  },
  {
    step: 3,
    title: "Professional Growth & Specialization",
    text: "Senior Financial Analyst / Financial Advisor / Finance or Accounting Manager",
    years: "Years 5-10",
  },
  {
    step: 4,
    title: "Leadership & Executive Roles",
    text: "Finance Director / Portfolio Manager / Controller or Chief Financial Officer (CFO)",
    years: "Years 10+",
  },
];
...
const skills = {
  hard: [
    ...
    { icon: "bi bi-bar-chart-line-fill", text: "Risk Management" },
    {
      ...
      text: "Data Visualization (Tableau/Power BI)",
    },
  ...
  soft: [
    ...
    { icon: "bi bi-lightbulb-fill", text: "Attention to Detail and Accuracy" },
    {
      ...
      text: "Client Management and Communication",
    },
...
const future = [
  {
    title: "FinTech and Automation",
    text: "Automation of routine accounting and transactional tasks. Demand for professionals with coding skills (Python, R) for algorithmic trading and data science.",
    borderClass: "border-custom-secondary",
    bgClass: "bg-warning-subtle",
  },
  {
    title: "Regulatory and Compliance Focus",
    text: "Increased scrutiny means roles in Risk Management, Anti-Money Laundering (AML), and regulatory compliance are expanding rapidly.",
    borderClass: "border-custom-primary",
    bgClass: "bg-primary-subtle",
  },
  {
    title: "Sustainable and ESG Investing",
    text: "Growing client demand for Environmental, Social, and Governance (ESG) investments creates new specialized analysis roles.",
