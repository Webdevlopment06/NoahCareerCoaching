...
const hero = {
  ...
  rolesSub:
    "Detailing common and specialized roles across academic and corporate settings.",
...
const roles = [
  {
    ...
    modal: {
      ...
      items: [
        {
          title: "Classroom Teacher (K-12)",
          text: "Delivering curriculum, classroom management, and student development.",
          bgClass: "bg-warning-subtle",
        },
        {
          title: "University Professor",
          text: "Advanced subject teaching, academic research, and publishing.",
        },
        {
          title: "Special Education Teacher",
          text: "Developing and implementing individualized education programs (IEPs).",
        },
        {
          title: "Tutor / Academic Coach",
          text: "Providing one-on-one or small-group instruction for specific subjects or skills.",
  ...
  },
  {
    ...
    modal: {
      ...
      items: [
        {
          title: "Instructional Designer (ID)",
          text: "Applying learning theories to design effective training programs (eLearning, blended learning).",
          bgClass: "bg-warning-subtle",
        },
        {
          title: "Training & Development Specialist",
          text: "Delivering, assessing, and managing professional development within a company.",
          bgClass: "bg-primary-subtle",
        },
        {
          title: "Curriculum Developer",
          text: "Creating and updating core educational content, aligned with standards and learning objectives.",
        },
      ],
    },
  },
      ...
      items: [
        {
          ...
          text: "Overseeing school operations, staff management, budgeting, and community relations.",
          bgClass: "bg-warning-subtle",
        },
        {
          title: "Librarian / Media Specialist",
          text: "Managing information resources and teaching digital literacy skills to students and staff.",
          bgClass: "bg-primary-subtle",
        },
        {
          title: "School Counselor / Psychologist",
          text: "Providing mental health support, career guidance, and academic advising.",
        },
      ],
    },
  },
...
const roadmap = [
  {
    ...
    text: "Education Assistant / Classroom Aide/ Tutor or After-School Instructor/ Camp Counselor or Youth Program Leader",
    years: "Years 0-2",
  },
  {
    step: 2,
    title: "Formal Education & Credentialing",
    text: "Student Teacher / Teaching Intern / Substitute Teacher",
    years: "Years 2-5",
  },
  {
    step: 3,
    title: "Professional Practice & Growth",
    text: "K–12 Teacher/ Postsecondary Instructor /Corporate Trainer / Instructional Specialist / Special Education Teacher",
    years: "Years 5-10",
  },
  {
    step: 4,
    title: "Specialization, Leadership, or Advancement",
    text: "School Administrator (Principal, Assistant Principal) / Instructional Coach or Curriculum Director / Higher Education Faculty / Training Manager or Education Consultant",
    years: "Years 10+",
  },
];
...
const skills = {
  ...
  soft: [
    { icon: "bi bi-people-fill", text: "Patience and Empathy" },
    {
      ...
      text: "Dynamic Communication and Public Speaking",
    },
    {
      icon: "bi bi-chat-dots-fill",
      text: "Conflict Resolution and Diplomacy with parents/students",
    },
    {
      icon: "bi bi-lightbulb-fill",
...
const future = [
  {
    ...
    text: "Growth in roles utilizing AI to tailor educational content to individual student paces. Need for educators proficient in data analytics to track student progress.",
    borderClass: "border-custom-secondary",
    bgClass: "bg-warning-subtle",
  },
  {
    title: "Rise of EdTech and Hybrid Models",
    text: "Increased integration of digital tools, virtual classrooms, and blended learning environments, requiring digital fluency.",
    borderClass: "border-custom-primary",
    bgClass: "bg-primary-subtle",
  },
  {
    title: "Corporate L&D Focus",
    text: "Learning & Development (L&D) departments are growing rapidly as companies invest in upskilling and reskilling their workforce.",
