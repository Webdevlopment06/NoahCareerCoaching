      ...
      items: [
        {
          ...
          text: "Solving complex business problems and driving organizational change.",
          bgClass: "bg-warning-subtle",
        },
        {
          title: "Business Analyst",
          text: "Bridging the gap between business needs and technological solutions.",
        },
        {
          title: "Product Manager",
          text: "Defining the product roadmap; coordinating engineering and marketing.",
        },
        {
          title: "Chief of Staff",
          text: "High-level organizational support and strategic initiatives.",
      ...
      items: [
        {
          ...
          text: "Budgeting, forecasting, financial modeling, and investment decision support.",
          bgClass: "bg-warning-subtle",
        },
        {
          title: "Human Resources Manager",
          text: "Workforce planning, talent acquisition, and regulatory compliance.",
          bgClass: "bg-primary-subtle",
        },
        {
          title: "Marketing Manager",
          text: "Developing and executing campaigns, market research, and brand strategy.",
        },
      ],
    },
  },
      ...
      items: [
        {
          ...
          text: "Optimizing daily processes, improving efficiency, and managing quality control.",
          bgClass: "bg-warning-subtle",
        },
        {
          title: "Supply Chain Specialist",
          text: "Managing logistics, procurement, and inventory to ensure smooth flow of goods.",
          bgClass: "bg-primary-subtle",
        },
        {
          title: "Project Manager (PMP)",
          text: "Defining scope, managing resources, mitigating risks, and delivering projects.",
        },
      ],
    },
  },
...
const roadmap = [
  {
    step: 1,
    title: "Entry Level",
    text: "Business Analyst / Assistant Manager",
    years: "Years 0-2",
  },
  {
    step: 2,
    title: "Mid-Level",
    text: "Department Manager / Operations Lead",
    years: "Years 3-6",
  },
  {
    step: 3,
    title: "Director",
    text: "Regional Director / Strategic Planning",
    years: "Years 7-12",
  },
  {
    step: 4,
    title: "Executive",
    text: "VP / COO / Chief Executive Officer",
    years: "Years 15+",
  },
];
...
const future = [
  {
    title: "Global & Sustainable Markets",
    text: "Emphasis on ESG reporting and increased complexity in international trade and operations.",
    borderClass: "border-custom-secondary",
    bgClass: "bg-warning-subtle",
  },
  {
    title: "Data-Driven Decision Making",
    text: "Managers must be proficient in Big Data analytics, visualization tools, and applying quantitative methods to strategy.",
    borderClass: "border-custom-primary",
    bgClass: "bg-primary-subtle",
  },
  {
    title: "Agile & Adaptive Leadership",
    text: "The shift towards flatter organizational structures requires leaders who can manage hybrid teams and rapid, iterative changes.",
