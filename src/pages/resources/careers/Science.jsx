...
const hero = {
  ...
  title: (
    <>
      Your Future in{" "}
      <span className="text-custom-primary">Science, Research & Discovery</span>
    </>
  ),
  blurb:
  ...
  rolesSub:
    "High-impact roles across biological, physical, and computational science.",
...
const roles = [
      ...
      items: [
        {
          ...
          text: "Conducting experiments to study living organisms, ecosystems, and biological processes.",
          bgClass: "bg-warning-subtle",
        },
        {
          title: "Biotechnologist",
          text: "Developing new products and techniques in medicine, agriculture, and industry using living systems.",
          bgClass: "bg-primary-subtle",
        },
        {
          title: "Clinical Research Coordinator",
          text: "Managing and overseeing clinical trials for new drugs and treatments.",
        },
      ],
    },
  },
      ...
      items: [
        {
          ...
          text: "Studying composition, structure, and properties of matter and developing new substances.",
          bgClass: "bg-warning-subtle",
        },
        {
          title: "Environmental Consultant",
          text: "Advising organizations on environmental compliance, pollution control, and sustainability practices.",
        },
      ],
    },
  },
  {
    ...
    modal: {
      ...
      items: [
        {
          title: "Data Scientist (Science Focus)",
          text: "Applying advanced statistical and computational methods to massive scientific datasets.",
          bgClass: "bg-warning-subtle",
        },
        {
          title: "Bioinformatician",
          text: "Developing software and algorithms to analyze complex biological data.",
          bgClass: "bg-primary-subtle",
        },
      ],
    },
...
const roadmap = [
  {
    step: 1,
    title: "Entry Level",
    text: "Lab Technician / Research Assistant",
    years: "Years 0-2",
  },
  {
    step: 2,
    title: "Mid-Level",
    text: "Research Scientist / Specialist",
    years: "Years 3-6",
  },
  {
    step: 3,
    title: "Senior / Lead",
    text: "Senior Scientist / Group Lead",
    years: "Years 7-12",
  },
  {
    step: 4,
    title: "PI / Director",
    text: "Principal Investigator / Lab Director",
    years: "Years 15+",
  },
];
...
const future = [
  {
    title: "Data-driven & AI-accelerated Research",
    text: "Machine learning, AI, and large-scale data analysis are transforming hypothesis generation and experiment design.",
    borderClass: "border-custom-primary",
    bgClass: "bg-primary-subtle",
  },
  {
    title: "Interdisciplinary & Translational Science",
    text: "Cross-disciplinary teams combining biology, engineering, and clinical expertise speed translation of discoveries.",
    borderClass: "border-custom-secondary",
    bgClass: "bg-warning-subtle",
  },
  {
    title: "Automation, High-throughput & Sustainability",
    text: "Lab automation, high-throughput screening, and greener lab practices increase reproducibility and reduce impact.",
