...
const hero = {
  ...
  title: (
    <>
      Your Future in{" "}
      <span className="text-custom-primary">Skilled Trades & Construction</span>
    </>
  ),
  blurb:
...
const roles = [
  {
    ...
    modal: {
      ...
      items: [
        {
          title: "Electrician",
          text: "Power systems, wiring, and control panels.",
          bgClass: "bg-warning-subtle",
        },
        {
          title: "HVAC Technician",
          text: "Climate systems installation and maintenance.",
        },
        {
          title: "Controls Technician",
          text: "PLCs, automation, and building controls.",
  ...
  },
  {
    ...
    modal: {
      ...
      items: [
        {
          title: "Carpenter",
          text: "Framing, finish carpentry, and site layout.",
          bgClass: "bg-warning-subtle",
        },
        {
          title: "Site Supervisor",
          text: "Managing crews, schedules, and safety compliance.",
          bgClass: "bg-primary-subtle",
        },
        {
          title: "Finisher / Painter",
          text: "Final finishes, quality control, and client handoffs.",
        },
      ],
    },
  },
      ...
      items: [
        {
          ...
          text: "Diagnostics, repair, and vehicle systems.",
          bgClass: "bg-warning-subtle",
        },
        {
          title: "Industrial Maintenance",
          text: "Heavy equipment servicing and preventive maintenance.",
          bgClass: "bg-primary-subtle",
        },
        {
          title: "Diesel Specialist",
          text: "Diesel engine repair and fleet maintenance.",
        },
      ],
    },
  },
...
const roadmap = [
  {
    step: 1,
    title: "Entry Level",
    text: "Apprentice / Junior Technician",
    years: "Years 0-2",
  },
  {
    step: 2,
    title: "Mid-Level",
    text: "Journeyman / Supervisor",
    years: "Years 3-6",
  },
  {
    step: 3,
    title: "Site Lead",
    text: "Foreman / Project Manager",
    years: "Years 7-12",
  },
  {
    step: 4,
    title: "Owner / Contractor",
    text: "Business Owner / Lead Contractor",
    years: "Years 15+",
  },
];
...
const future = [
  {
    title: "Green Building and Retrofitting",
    text: "High demand for HVAC and Electricians specializing in solar, energy efficiency, and low-voltage systems; focus on BMS for energy optimization.",
    borderClass: "border-custom-secondary",
    bgClass: "bg-secondary-subtle",
  },
  {
    title: "Automation and Robotics",
    text: "Industrial Maintenance Mechanics and Welders must adapt to servicing and programming robotic assembly lines and advanced manufacturing equipment.",
    borderClass: "border-custom-primary",
    bgClass: "bg-danger-subtle",
  },
  {
    title: "Digital Project Management",
    text: "Project coordination increasingly uses digital tools (BIM, digital blueprints, virtual reality) to improve site efficiency and reduce errors.",
