...
const hero = {
  ...
  rolesSub: 'High-impact careers across advocacy, compliance, and the court system.',
...
const roles = [
  {
    ...
    modal: {
      ...
      items: [
        { title: 'Corporate Attorney', text: 'Advising businesses on contracts, mergers, regulations, and liability issues.', bgClass: 'bg-warning-subtle' },
        { title: 'Litigation Attorney', text: 'Representing clients in civil lawsuits, including research, discovery, and trial.' },
        { title: 'Intellectual Property Lawyer', text: "Protecting clients' creations (patents, copyrights, trademarks).", bgClass: 'bg-primary-subtle' }
      ]
    }
  },
  {
    ...
    modal: {
      ...
      items: [
        { title: 'Public Defender', text: 'Providing legal defense to indigent defendants in criminal court cases.', bgClass: 'bg-warning-subtle' },
        { title: 'Prosecutor (District Attorney)', text: 'Representing the government in criminal cases.' }
      ]
    }
  },
  {
    ...
    modal: {
      ...
      items: [
        { title: 'Paralegal / Legal Assistant', text: 'Conducting legal research, drafting documents, and assisting attorneys in case preparation.', bgClass: 'bg-warning-subtle' },
        { title: 'Mediator / Arbitrator', text: 'Facilitating resolution between parties outside of formal trial settings.', bgClass: 'bg-primary-subtle' }
      ]
    }
  }
]
...
const roadmap = [
  { step: 1, title: 'Entry Level', text: 'Paralegal / Junior Associate', years: 'Years 0-2' },
  { step: 2, title: 'Mid-Level', text: 'Associate / Prosecutor / Public Defender', years: 'Years 3-6' },
  { step: 3, title: 'Senior / Lead', text: 'Senior Counsel / Trial Lead', years: 'Years 7-12' },
  { step: 4, title: 'Partner / Judge', text: 'Firm Partner / Judge / In-House Counsel Director', years: 'Years 15+' }
]
...
const future = [
  { title: 'Legal Tech & AI', text: 'Automation for document review and AI-assisted research will change workflows.', borderClass: 'border-custom-secondary', bgClass: 'bg-warning-subtle' },
  { title: 'Access to Justice', text: 'Growth in pro bono tools and ADR to expand legal help.', borderClass: 'border-custom-primary', bgClass: 'bg-primary-subtle' },
  { title: 'Regulatory Complexity', text: 'Demand for specialized counsel in privacy, compliance, and IP.', borderClass: 'border-secondary', bgClass: 'bg-secondary-subtle' }
]
