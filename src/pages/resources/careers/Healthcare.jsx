...
const hero = {
  ...
  rolesSub:
    "Detailing high-impact roles across clinical, allied, and administrative health.",
      ...
      items: [
        {
          ...
          text: "Diagnosing and treating complex diseases; surgical or specialized care.",
          bgClass: "bg-warning-subtle",
        },
        {
          title: "Registered Nurse (RN)",
          text: "Administering care, patient education, and coordinating treatment teams.",
        },
        {
          title: "Nurse Practitioner (NP)",
          text: "Advanced nursing roles with prescriptive authority in many settings.",
        },
        {
          title: "Physician Assistant (PA)",
          text: "Practicing medicine under physician supervision, conducting exams and diagnosing.",
      ...
      items: [
        {
          ...
          text: "Helping patients regain movement and manage pain after injury or illness.",
          bgClass: "bg-warning-subtle",
        },
        {
          title: "Medical Technologist",
          text: "Performing complex lab tests and analyzing results to aid diagnosis.",
          bgClass: "bg-primary-subtle",
        },
        {
          title: "Radiologic Technologist",
          text: "Operating imaging equipment (X-ray, CT, MRI) to produce diagnostic images.",
        },
      ],
    },
  },
      ...
      items: [
        {
          ...
          text: "Overseeing operations, finance, and quality control of healthcare facilities.",
          bgClass: "bg-warning-subtle",
        },
        {
          title: "Health Informatics Specialist",
          text: "Managing patient data, EHR systems, and health IT security.",
          bgClass: "bg-primary-subtle",
        },
        {
          title: "Public Health Specialist",
          text: "Analyzing community health trends and developing preventative programs.",
        },
      ],
    },
  },
...
const roadmap = [
  {
    step: 1,
    title: "Entry & Foundations",
    text: "CNA / Medical Assistant / Phlebotomist / Patient Care Tech",
    years: "Years 0-2",
  },
  {
    step: 2,
    title: "Technical & Allied Roles",
    text: "RN / Radiologic Technologist / Respiratory Therapist / PTA",
    years: "Years 2-5",
  },
  {
    step: 3,
    title: "Advanced Clinical & Specialized",
    text: "NP / PA / PT / OT / Clinical Specialist",
    years: "Years 5-8",
  },
  {
    step: 4,
    title: "Leadership & Systems",
    text: "Healthcare Administrator / Clinical Director / Health Informatics Manager",
    years: "Years 10+",
  },
];
...
const future = [
  {
    ...
    text: "Growth in virtual care and remote patient monitoring platforms.",
    borderClass: "border-custom-secondary",
    bgClass: "bg-warning-subtle",
  },
  {
    title: "Geriatric & Home Care",
    text: "Aging populations increase demand for in-home and geriatric services.",
    borderClass: "border-custom-primary",
    bgClass: "bg-primary-subtle",
  },
  {
    title: "Health Data Analytics",
    text: "Using clinical data to improve outcomes, reduce costs, and guide public health responses.",
