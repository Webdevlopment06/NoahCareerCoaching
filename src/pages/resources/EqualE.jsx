          ...
          <div className="row align-items-center">
            <div className="col-lg-8">
              ...
              <p className="lead mb-4 opacity-75">
                We are committed to a workplace free from discrimination and
                harassment. Employment decisions are based on merit, competence,
                and performance—not personal characteristics.
              </p>
              <div className="d-flex gap-3">
                <span className="badge border border-light p-2 px-3">
                  Federal Compliance
                </span>
                <span className="badge border border-light p-2 px-3">
                  Inclusive Hiring
      ...
      <section className="py-5 bg-white">
        <div className="container">
          ...
          <p className="text-muted mb-5">
            Discrimination occurs when an adverse employment action (hiring,
            firing, pay, promotion) is taken based on any of the following
            protected characteristics:
          </p>
            ...
            <div className="col-md-4">
              <div className="h-100 p-4 border-start border-4 border-primary bg-light shadow-sm">
                ...
                <p className="small">
                  ...
                  <strong>Race, Color, Religion, Sex, National Origin</strong>,
                  and <strong>Age</strong> (40 and older).
                </p>
                <div className="d-flex gap-2 mt-3">
                  <a
                    href="https://www.eeoc.gov/statutes/title-vii-civil-rights-act-1964"
                    target="_blank"
                    rel="noreferrer noopener"
                    className="btn btn-sm btn-outline-primary"
                  >
                    Title VII — Learn more
                  </a>
                  <a
                    href="https://www.eeoc.gov/statutes/age-discrimination-employment-act-1967"
                    target="_blank"
                    rel="noreferrer noopener"
                    className="btn btn-sm btn-outline-primary"
                  >
            ...
            <div className="col-md-4">
              <div className="h-100 p-4 border-start border-4 border-info bg-light shadow-sm">
                ...
                <p className="small">
                  ...
                  <strong>Physical or Mental Disabilities</strong> and prohibits
                  the use of <strong>Genetic Information</strong> in hiring.
                </p>
                <div className="d-flex gap-2 mt-3">
                  <a
                  ...
                  <a
                    href="https://www.eeoc.gov/statutes/genetic-information-nondiscrimination-act-2008"
                    target="_blank"
                    rel="noreferrer noopener"
                    className="btn btn-sm btn-outline-primary"
                  >
            ...
            <div className="col-md-4">
              <div className="h-100 p-4 border-start border-4 border-dark bg-light shadow-sm">
                ...
                <p className="small">
                  ...
                  <strong>equal pay for equal work</strong> in all forms of
                  compensation.
                </p>
                <div className="d-flex gap-2 mt-3">
                  <a
                    href="https://www.eeoc.gov/statutes/equal-pay-act-1963"
                    target="_blank"
                    rel="noreferrer noopener"
                    className="btn btn-sm btn-outline-primary"
                  >
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-6">
              ...
              <p>
                We provide reasonable accommodations for the known physical or
                mental limitations of an otherwise qualified individual with a
                disability who is an applicant or an employee.
              </p>
              ...
              <div className="mt-4">
                <div className="d-flex mb-3">
                  ...
                  <div>
                    ...
                    <p className="small">
                      Contact our HR Accessibility Team during the application
                      or interview phase.
                    </p>
                  </div>
                </div>
                <div className="d-flex mb-3">
                  ...
                  <div>
                    ...
                    <p className="small">
                      A collaborative discussion to identify the precise
                      limitations and potential accommodations.
                    </p>
                  </div>
                </div>
                <div className="d-flex">
                  ...
                  <div>
                    ...
                    <p className="small">
                      Applying tools (e.g., screen readers, flexible scheduling)
            ...
            <div className="col-lg-5 offset-lg-1">
              <div className="card border-0 shadow-lg rounded-4 p-4 text-white bg-dark">
                ...
                <p className="small">
                  It is strictly prohibited for an employer to retaliate against
                  you for:
                </p>
        ...
        <div className="container">
          <div className="text-center mb-5">
            ...
            <p className="text-muted">
              If you believe your rights have been violated, we provide multiple
          ...
          <div className="row g-4 text-center">
            <div className="col-md-4">
              <div className="p-4 border rounded-4 h-100">
                ...
                <p className="small text-muted">
                  Submit a confidential report through our Employee Relations
                  platform.
                </p>
              </div>
            </div>
            <div className="col-md-4">
              <div className="p-4 border rounded-4 h-100">
                ...
                <p className="small text-muted">
                  Call our 24/7 anonymous third-party hotline for unbiased
                  intake.
                </p>
              </div>
            </div>
            <div className="col-md-4">
              <div className="p-4 border rounded-4 h-100">
                ...
                <p className="small text-muted">
                  Applicants also have the right to file a charge with the U.S.
        ...
        <div className="container py-4">
          <div className="row align-items-center">
            <div className="col-lg-8">
              ...
              <p className="lead mb-4 opacity-75">
                Professionalism is our baseline. Harassment is any unwelcome
                conduct based on a protected characteristic that creates an
              ...
              <div className="bg-white bg-opacity-10 p-3 rounded-3 border border-light border-opacity-25">
                <small className="fw-bold text-info">
                  <i className="bi bi-info-circle me-1"></i> Core Principle:
                </small>
                <p className="small mb-0 italic">
                  "It is not the intent of the perpetrator, but the impact on
                  the victim and the workplace that defines harassment."
                </p>
              </div>
            </div>
          ...
          <div className="row g-4">
              ...
              <div className="card h-100 border-0 shadow-sm bg-light">
                <div className="card-body p-4">
                  <h5 className="fw-bold text-danger">
                    <i className="bi bi-chat-square-dots-fill me-2"></i>Verbal
                    Conduct
                  </h5>
            ...
            <div className="col-md-4">
              <div className="card h-100 border-0 shadow-sm bg-light">
                <div className="card-body p-4">
                  <h5 className="fw-bold text-danger">
                    <i className="bi bi-eye-fill me-2"></i>Visual Conduct
                  </h5>
                  <ul className="small text-muted ps-3">
                    <li>
            ...
            <div className="col-md-4">
              <div className="card h-100 border-0 shadow-sm bg-light">
                <div className="card-body p-4">
                  <h5 className="fw-bold text-danger">
                    <i className="bi bi-hand-index-thumb-fill me-2"></i>Physical
                    Conduct
                  </h5>
                  <ul className="small text-muted ps-3">
        ...
        <div className="container">
          <div className="row align-items-center g-5">
            <div className="col-md-6">
              ...
              <p className="text-muted">
                Latin for <em>"This for That."</em> Occurs when a supervisor or
                person in authority conditions a job benefit (promotion, raise,
                or keeping a job) on an employee's submission to unwelcome
                sexual advances.
              </p>
              <div className="p-3 bg-white rounded border-start border-4 border-danger small">
                <strong>Example:</strong> "If you go to dinner with me tonight,
                I'll make sure you get that bonus."
              </div>
            </div>
            <div className="col-md-6">
              <h3 className="fw-bold">2. Hostile Work Environment</h3>
              <p className="text-muted">
                Occurs when unwelcome conduct is{" "}
                <strong>severe or pervasive</strong> enough to change the
                conditions of employment and create an abusive atmosphere.
              </p>
              <div className="p-3 bg-white rounded border-start border-4 border-danger small">
                <strong>Example:</strong> Continuous, daily use of racial slurs
                that makes it impossible for an employee to focus on their work.
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-5 bg-white">
        <div className="container text-center">
          ...
          <p className="mb-5 text-muted mx-auto max-w-700">
            A safe workplace is everyone's responsibility. If you witness
            harassment, we encourage a "See Something, Say Something" culture.
          </p>
          ...
          <div className="row justify-content-center g-4">
            <div className="col-md-4">
              <div className="p-4 rounded-4 border shadow-sm">
                ...
                <p className="small text-muted">
                  If safe, tell the individual their behavior is unwelcome and
                  must stop.
                </p>
              </div>
            </div>
            <div className="col-md-4">
              <div className="p-4 rounded-4 border shadow-sm">
                ...
                <p className="small text-muted">
                  Note dates, times, and witnesses. Offer support to the person
                  being targeted.
                </p>
              </div>
            </div>
            <div className="col-md-4">
              <div className="p-4 rounded-4 border shadow-sm">
                ...
                <p className="small text-muted">
                  Report to HR or use the anonymous hotline. Every report is
                  investigated.
                </p>
              </div>
            </div>
          ...
          <div className="mt-5 p-4 rounded-pill bg-dark text-white d-inline-block px-5">
            <span className="fw-bold text-info">Zero Tolerance Policy:</span>{" "}
            Confirmed harassment will result in disciplinary action, up to and
