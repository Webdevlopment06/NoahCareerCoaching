            ...
            <div className="col-lg-4 mb-5 mb-lg-0">
              <div className="pe-lg-4">
                ...
                <p className=" text-dark small mb-4">
                  Stop searching. Start landing. We provide the expert guidance
                  to help you unlock your full professional potential.
                </p>
              ...
              <div className="row g-3 mb-5">
                <div className="col-md-4">
                  <div className="card h-100 bg-transparent border-success rounded-4 p-3 shadow-sm animate-scale-up-blue-outline">
                    ...
                    <p className="small text-dark mt-2 mb-0">
                      Stand out to recruiters with a professional career
                      roadmap.
                    </p>
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="card h-100 bg-transparent border-success rounded-4 p-3 shadow-sm animate-scale-up-blue-outline">
                    ...
                    <p className="small mt-2 text-dark mb-0">
                      Mock interviews to turn your nerves into confidence.
                    </p>
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="card h-100 bg-transparent border-success rounded-4 p-3 shadow-sm animate-scale-up-blue-outline">
                    ...
                    <p className="small mt-2 text-dark mb-0">
                      Don't just apply - get referred and get noticed.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="row g-4">
                <div className="col-md-6">
                  <div className="flex-ai-center gap-3">
                    <img
                      loading="lazy"
                      src="/images/home-imgs/sanh.jpg"
                      className="rounded-circle border border-success border-2 avatar-48"
                      alt="Sanh K."
                    />
                    <div className="border-start border-secondary ps-3">
                      <p className="small text-dark fst-italic mb-0">
                        "Noah helped me land my dream job!"
                      </p>
                      <footer className="blockquote-footer text-dark mt-1 mb-0">
                        Sanh K.
                      </footer>
                    </div>
                  </div>
                ...
                <div className="col-md-6">
                  <div className="flex-ai-center gap-3">
                    ...
                    <div className="border-start border-secondary ps-3">
                      <p className="small text-dark fst-italic mb-0">
                        "Found real confidence - get hired faster!"
                      </p>
                      <footer className="blockquote-footer text-dark mt-1 mb-0">
                        Mait M.
                      </footer>
