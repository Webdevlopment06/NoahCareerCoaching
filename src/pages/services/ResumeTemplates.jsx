...
const TEMPLATES = {
  ...
  modern: {
    ...
    phone: "(555) 123-4567",
    summary:
      "Creative and data-driven professional focused on measurable impact and agile delivery.",
    experience:
  ...
  creative: {
    ...
    phone: "(555) 987-6543",
    summary:
      "Multidisciplinary designer blending visual storytelling and user research to create delightful experiences.",
    experience:
  ...
  executive: {
    ...
    phone: "(555) 000-1111",
    summary:
      "Strategic leader with extensive experience scaling teams and driving operational excellence.",
    experience:
      ...
      <div className="container">
        <header className="text-center mb-4">
          ...
          <p className="text-muted">
            Select a design that fits your career goals
          </p>
        </header>

        <div className="resume-templates-grid">
          <article className="resume-template-card">
            <div className="resume-template-preview flex-ai-center justify-content-center">
              Classic
            </div>
            <div className="resume-template-body">
              <h3>Classic</h3>
              <p className="text-muted">
                Clean, professional, and ATS-friendly.
              </p>
              <div className="resume-template-actions">
                <button
                  onClick={() => openPreview("classic")}
                  className="resume-template-btn resume-template-btn-preview btn btn-outline-secondary me-2"
                >
                  Preview
                </button>
                <button
                  onClick={() => useTemplate("classic")}
                  className="resume-template-btn resume-template-btn-select btn btn-primary"
                >
                  Use Template
                </button>
              </div>
          ...
          <article className="resume-template-card">
            ...
            <div className="resume-template-body">
              <h3>Modern</h3>
              <p className="text-muted">
                Stylish layout with a contemporary feel.
              </p>
              <div className="resume-template-actions">
                <button
                  onClick={() => openPreview("modern")}
                  className="resume-template-btn resume-template-btn-preview btn btn-outline-secondary me-2"
                >
                  Preview
                </button>
                <button
                  onClick={() => useTemplate("modern")}
                  className="resume-template-btn resume-template-btn-select btn btn-primary"
                >
                  Use Template
                </button>
          ...
          <article className="resume-template-card">
            ...
            <div className="resume-template-body">
              <h3>Executive</h3>
              <p className="text-muted">
                Bold and refined for leadership roles.
              </p>
              <div className="resume-template-actions">
                <button
                  onClick={() => openPreview("executive")}
                  className="resume-template-btn resume-template-btn-preview btn btn-outline-secondary me-2"
                >
                  Preview
                </button>
                <button
                  onClick={() => useTemplate("executive")}
                  className="resume-template-btn resume-template-btn-select btn btn-primary"
                >
                  Use Template
                </button>
