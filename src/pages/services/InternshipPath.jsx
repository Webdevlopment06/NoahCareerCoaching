    ...
    <main>
      ...
      >
        <div className="small text-white">
          ...
          <div className="small text-white">Skill Discovery • Real-World Project Placement</div>
        </div>
      </ServiceHero>
        ...
        <div className="container">
          ...
          <div className="row align-items-center justify-content-center">
            <div className="col-md-4 text-center mb-4 mb-md-0">
              <img loading="lazy" src="/images/services-imgs/mentor2.jpg" className="rounded-pill border border-4 border-white shadow shadow-lg" alt="Mentor" />
            </div>
            <div className="col-md-6">
