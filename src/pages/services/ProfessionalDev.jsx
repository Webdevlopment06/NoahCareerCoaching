...
export default function ProfessionalDev() {
  return (
    <main>
      <ServiceHero
        title="Close the Skills Gap. Lead the Future."
        subtitle="In the next 5 years, 40% of core skills will change. Are you evolving fast enough to remain indispensable?"
      >
