    ...
    <main>
      <section id="hero" className="about-hero">
        ...
        <div className="position-relative">
          <h1 className="display-3 fw-bold mb-3 fs-hero-clamp">Our Mission</h1>

          <p className="lead fs-lead-clamp">
            Empowering individuals to grow, transform, and find purpose through
            guidance, education, and meaningful support.
          </p>
        </div>
      </section>
        ...
        <div className="container my-5">
          <div className="row g-4 align-items-center">
            <div className="col-lg-6">
              <img
                loading="lazy"
                src="/images/about-imgs/career.png"
                className="img-fluid w-100 h-100 object-fit-cover rounded min-h-400"
                alt="Large Section"
              />
            </div>
            ...
            <div className="col-lg-6 d-flex flex-column align-items-center text-center">
              <img
                loading="lazy"
                src="/images/about-imgs/chris.png"
                className="rounded-circle mb-3 img-180"
              ...
              <div className="d-flex gap-3">
                <a
                  href="https://www.facebook.com/p/Noah-Career-Coaching-61578635225209/"
                  target="_blank"
                ...
                <a
                  href="https://www.instagram.com/p/DOytPcRkRr5/"
                  target="_blank"
                  rel="noreferrer noopener"
                  className="text-dark"
                >
                ...
                <a
                  href="https://www.linkedin.com/in/christopher-noah-a48a8a376"
                  target="_blank"
                  rel="noreferrer noopener"
                  className="text-dark"
                >
      ...
      <section id="join" className="py-5 about-join">
        <div className="container text-center text-white">
          ...
          <p className="mb-5">
            Choose the path that best fits your goals and start benefiting right
            away.
          </p>
      ...
      <section id="donation" className="py-5 donation-section">
        <div className="container text-center">
          <blockquote className="fs-3 fw-semibold lh-140">
            "Your generosity fuels the mission — every donation helps
            non‑profits transform lives and build stronger communities."
          </blockquote>
        </div>
      </section>
        ...
        <div className="container">
          <div className="text-center mb-5">
            ...
            <p className="lead mx-auto max-w-700">
              Your contribution helps us continue offering essential community
              support, career guidance, and resources to individuals in need.
          ...
          <div className="text-center mt-5">
            <p className="text-muted mx-auto max-w-700">
              Noah Career Coaching is committed to transparency and impact. All
              donations directly support program growth, client resources, and
