...
const ResumeTemplates = React.lazy(() => import('./pages/services/ResumeTemplates'))
...
const ArtsDesign = React.lazy(() => import('./pages/resources/careers/ArtsDesign'))
const BusinessManagement = React.lazy(() => import('./pages/resources/careers/BusinessManagement'))
const Education = React.lazy(() => import('./pages/resources/careers/Education'))
const Finance = React.lazy(() => import('./pages/resources/careers/Finance'))
const Healthcare = React.lazy(() => import('./pages/resources/careers/Healthcare'))
const Hospitality = React.lazy(() => import('./pages/resources/careers/Hospitality'))
const Law = React.lazy(() => import('./pages/resources/careers/Law'))
const Science = React.lazy(() => import('./pages/resources/careers/Science'))
const Technology = React.lazy(() => import('./pages/resources/careers/Technology'))
...
const ProfessionalDev = React.lazy(() => import('./pages/services/ProfessionalDev'))
const Volunteer = React.lazy(() => import('./pages/services/Volunteer'))
const InternshipPath = React.lazy(() => import('./pages/services/InternshipPath'))
